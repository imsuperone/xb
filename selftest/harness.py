...
try:
    ...
    from .checks import snap_full, eval_check
    ...
    try:
        from selftest.checks import snap_full, eval_check
        from selftest.probes import SUITES, SUITE_MODS
    except ImportError:
        from checks import snap_full, eval_check  # type: ignore
...
def _grant_spirits(v_gid, v_qq, bag=None):
    try:
