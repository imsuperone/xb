...
> 版本：`v0.7.37` ｜ 对象：想从头到尾看懂这份代码的人（函数行号仍以 v0.7.28 为准，v0.7.29~37  printing 偏移：slave.py 查询块 -15 行、app.js +80 行、game.py +25 行左右）
...
指令：奴隶系统/我的信息/查询（@QQ/昵称/我）/买下/折磨/保护/释放/赎身/我要自由/买奴隶位/打架/抽武器/十/三十/五十连抽/升星/升阶/打工/收工/造反/讨好/学习/祈福/武器菜单/宝物菜单/身价榜/签到榜/排行榜/直接发武器宝物名查详情。（补偿已退役，v0.7.37 起删除；转账请用银行转账）
...
| 图鉴 | 宝物/精灵总览（改动即时存，只动各自范围；武器坐骑只在商城，v0.7.36/37 起不在图鉴展示） |
