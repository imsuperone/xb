...
> 版本：`v0.7.36` ｜ 对象：想从头到尾看懂这份代码的人（函数行号仍以 v0.7.28 为准，v0.7.29~36  printing 偏移：slave.py 查询块 -15 行、app.js +80 行、game.py +25 行左右）
...
| 图鉴 | 宝物/坐骑/精灵总览（改动即时存，只动各自范围；武器只在商城，v0.7.36 起不在图鉴展示） |
