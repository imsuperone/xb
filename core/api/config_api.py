...
PRESETS = {
    "standard": {
        ...
        "间隔配置": {
            ...
            "造反间隔": "1", "打赏间隔": "1", "释放间隔": "1", "赎身间隔": "30", "自由间隔": "30", "保护间隔": "10",
            "货币间隔": "1"
        },
        "费用配置": {
        ...
        "银行配置": {
            ...
            "劫狱消耗体力": "5", "劫狱间隔": "1", "劫狱魅力减少": "0", "打劫银行间隔": "10", "进监狱增加体力": "10"
        },
        "娱乐配置": {
        ...
        "商城图鉴": {
            "ride_shop": json.dumps({"企鹅": 20000, "伞兵": 50000, "宝驴": 100000, "保时捷": 250000, "法拉利": 500000, "玛莎拉蒂": 800000, "劳斯莱斯": 1500000, "布加迪威龙": 3000000, "私人航空": 8000000, "女仆": 15000000}, ensure_ascii=False),
    ...
    "casual": {
        ...
        "间隔配置": {
            ...
            "造反间隔": "1", "打赏间隔": "1", "释放间隔": "1", "赎身间隔": "30", "自由间隔": "30", "保护间隔": "5",
            "货币间隔": "1"
        },
        "费用配置": {
        ...
        "银行配置": {
            ...
            "劫狱消耗体力": "3", "劫狱间隔": "1", "劫狱魅力减少": "0", "打劫银行间隔": "5", "进监狱增加体力": "20"
        },
        "娱乐配置": {
        ...
        "商城图鉴": {
            "ride_shop": json.dumps({"企鹅": 10000, "伞兵": 25000, "宝驴": 50000, "保时捷": 120000, "法拉利": 250000, "玛莎拉蒂": 400000, "劳斯莱斯": 800000, "布加迪威龙": 1500000, "私人航空": 4000000, "女仆": 8000000}, ensure_ascii=False),
    ...
    "hardcore": {
        ...
        "间隔配置": {
            ...
            "造反间隔": "2", "打赏间隔": "1", "释放间隔": "1", "赎身间隔": "30", "自由间隔": "30", "保护间隔": "15",
            "货币间隔": "2"
        },
        "费用配置": {
        ...
        "银行配置": {
            ...
            "劫狱消耗体力": "10", "劫狱间隔": "2", "劫狱魅力减少": "1", "打劫银行间隔": "20", "进监狱增加体力": "5"
        },
        "娱乐配置": {
        ...
        "商城图鉴": {
            "ride_shop": json.dumps({"企鹅": 40000, "伞兵": 100000, "宝驴": 200000, "保时捷": 500000, "法拉利": 1000000, "玛莎拉蒂": 1600000, "劳斯莱斯": 3000000, "布加迪威龙": 6000000, "私人航空": 15000000, "女仆": 30000000}, ensure_ascii=False),
            ...
            if pre_snapshot and not pre_snapshot.startswith("pre_balance_"):
                ...
                if _raw:
                    ...
                    if not isinstance(_idx, list):
                        _idx = []
                    _idx = [_new_name] + [x for x in _idx if x != _new_name][:19]
                    ST.recall_set("cfgsnap__index", json.dumps(_idx, ensure_ascii=False))
